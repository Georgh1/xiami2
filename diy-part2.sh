...
sed -i '/uci commit system/i\uci set system.@system[0].hostname='Xiaomi-R4b'' package/lean/default-settings/files/zzz-default-settings
...
sed -i 's/ssid=OpenWrt/ssid=Xiaomi_R4b/g' package/kernel/mac80211/files/lib/wifi/mac80211.sh
